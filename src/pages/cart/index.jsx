...
export default function Cart() {
  ...
  return (
    <>
          ...
          {cart.length > 0 && (
            <div className="w-full md:w-1/3 bg-white p-6 rounded-tr-3xl rounded-br-3xl border-l border-gray-200">
              ...
              <div
                ...
                className="border-b border-gray-900 p-3 text-gray-800  hover:bg-slate-50 cursor-pointer"
              >
      ...
      {openAddress && <AddressDialog onClose={onCloseAddressDialog} />}
      {openCoupon && <CouponDialog onClose={onCloseCouponDialog} />}
    </>
  );
}
